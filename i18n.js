...
const KO_DICT = [
  ...
  ['.company .section-sub', '국내 대표 상장사들의 2년간 AI 도입 활동을 공개 기록으로 분석했습니다. 시장의 공백은 AI 교육이 아니라, 실행 이후를 측정하는 운영 계층이었습니다.'],
  ['.company-card:nth-child(1) .company-k', '우리가 발견한 공백'],
  ['.company-card:nth-child(1) h3', '모두가 업무를 재설계하지만, 측정하는 곳은 없었습니다.'],
  ['.company-card:nth-child(1) p', '업무 재설계는 가장 활발한 도입 영역이었지만, 효과·ROI 측정은 어떤 측정 방법으로 세어도 유일하게 비어 있었습니다. 출처: 바리온랩스 연구소 BL-IA-2026-03.'],
  ...
  ['#onprem .onprem-partner-rows p:nth-child(1)', '<strong>1단계 · 단기 온보딩</strong> — 실제 업무에서 바로 측정을 시작합니다. 좌석 단위 · 당일 시작, 설치·서버·사전 세팅 없이. 첫 실행 데이터가 시작한 날 쌓입니다.'],
  ['#onprem .onprem-partner-rows p:nth-child(2)', '<strong>2단계 · 연간 구독</strong> — AX 성과측정 리포트가 포함된 상시 운영입니다. 운영 전후 동일 지표 비교, 프로젝트별 정책·비용 상한, 관리자 콘솔 제공. 견적은 도입 상담으로 안내합니다.'],
  ...
  ['.faq-list details:nth-of-type(2) p',
    '두 단계입니다. <strong>단기 온보딩</strong>: 좌석 단위 · 당일 시작 — 첫날부터 실제 업무에서 측정합니다. <strong>연간 구독</strong>: AX 성과측정 리포트가 포함된 상시 운영입니다. 견적은 조직 규모·범위에 따라 <a href="service.html#inquiry">도입 상담</a>에서 안내합니다. Vibecamp 개인 강의는 무료이며, 기업교육은 구독형입니다.'],
